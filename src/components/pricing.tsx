    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-3">
        ...
        <div className="flex justify-between items-center gap-8 mb-8">
          <div>
            <h3 className="text-base font-medium text-[#070F0B] mb-2">Credit Value</h3>
            <p className="text-2xl text-[#4E5563]">N100 = 1 YES Credit (1YC)</p>
          </div>
          <div>
            <h3 className="text-base font-medium text-[#070F0B] mb-2">Credit Purchase</h3>
            <p className="text-2xl text-[#4E5563]">Minimum Purchase: N3,000 (equivalent to 30 YES Credits).</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Premium Card */}
          <Card className="bg-[#00AC47] h-full pt-3">
            <div className="bg-white h-full rounded-t-lg flex flex-col py-3">
              <CardHeader className="text-center pb-4">
                <h6 className="text-xl md:text-2xl text-center text-[#101720] text-[400] mb-12">PREMIUM</h6>
              </CardHeader>
              <CardContent className="h-[calc(100% - 100px)] flex-grow flex flex-col justify-between items-center">
                <div className="">
                  <div className="text-center">
                    <div className="text-4xl font-medium text-[#00AC47]">N 20,000</div>
